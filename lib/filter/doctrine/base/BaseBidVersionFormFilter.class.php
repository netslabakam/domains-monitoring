...
/**
 * BidVersion filter form base class.
 *
 * @package    sf
 * @subpackage filter
 * @author     Atma
 ...
 */
abstract class BaseBidVersionFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('bid_version_filters[%s]');
