 ...
 * @method clob      getVariables()       Returns the current record's "variables" value
 ...
 * @method csSetting setVariables()       Sets the current record's "variables" value
 * 
 * @package    sf
 * @subpackage model
 * @author     Atma
...
abstract class BasecsSetting extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('variables', 'clob', null, array(
             'type' => 'clob',
             'default' => '',
             ));
    }
