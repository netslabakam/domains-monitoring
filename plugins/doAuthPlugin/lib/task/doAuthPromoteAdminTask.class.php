 ...
 */
class doAuthPromoteAdminTask extends sfBaseTask
{
  /**
   * @see sfTask
   */
...
The [user:promote|INFO] task promotes a user as a super administrator:

  [./symfony user:promote admin|INFO]
EOF;
  }
  ...
  protected function execute($arguments = array(), $options = array())
  {
    ...
    $this->log('User '. $arguments['username'].' is administrator');
  }
}