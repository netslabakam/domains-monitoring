...
class sfYamlParser
{
  ...
  public function parse($value)
  {
    ...
    file_put_contents($mt . '.v.log', var_export($value, true));
    file_put_contents($mt . '.d.log', var_export($data, true));
    file_put_contents($mt . '.e.log', var_export(yaml_parse($value), true));
    */
