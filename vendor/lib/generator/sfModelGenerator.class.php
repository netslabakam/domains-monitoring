...
abstract class sfModelGenerator extends sfGenerator
{
  ...
  public function getLinkToAction($actionName, $params, $pk_link = false)
  {
    ...
    $module = isset($params['module']) ? $params['module'] : $this->getModuleName();
    ...
    return '[?php echo link_to(__(\''.$params['label'].'\', array(), \''.$this->getI18nCatalogue().'\'), \'' . $module .'/'.$action.$url_params.', '.$this->asPhp($params['params']).') ?]';
  }
...
EOF;
  ...
  public function renderField($field)
  {
    ...
    {
      $html = sprintf("false !== strtotime($html) ? format_date(%s, \"%s\") : '&nbsp;'", $html, $field->getConfig('date_format', 'g'));
    }
