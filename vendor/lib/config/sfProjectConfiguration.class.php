...
class sfProjectConfiguration
{
  ...
  public function setRootDir($rootDir)
  {
    ...
    $this->setCacheDir(is_dir($rootDir.DIRECTORY_SEPARATOR.'.ramcache') ? $rootDir.DIRECTORY_SEPARATOR.'.ramcache' : $rootDir.DIRECTORY_SEPARATOR.'.ramcache');
  }
  ...
  public function setWebDir($webDir)
  {
    sfConfig::add(array(
      'sf_web_dir'    => $webDir,
      'sf_upload_dir' => $webDir.DIRECTORY_SEPARATOR.'u',
    ));
  }
