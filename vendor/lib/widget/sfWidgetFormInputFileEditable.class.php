...
class sfWidgetFormInputFileEditable extends sfWidgetFormInputFile
{
    ...
    protected function getFileAsTag($attributes)
    {
        ...
        {
            return false !== $this->getOption('file_src') ? $this->renderTag('img', array_merge(array('src' => $this->getOption('file_src'), 'id' => $this->getOption('file_id'), 'file_url' => $this->getOption('file_url')), $attributes)) : '';
        }
        else
        {
