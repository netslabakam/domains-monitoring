...
class sfSessionStorage extends sfStorage
{
    ...
    public function initialize($options = null)
    {
        ...
        $options = array_merge(array(
            ...
            'session_cookie_path' => isset($_SERVER['PATH_PREFIX']) && $_SERVER['PATH_PREFIX'] != '' ? $_SERVER['PATH_PREFIX'] . '/' : $cookieDefaults['path'],
        ...
        if (isset($_SERVER['AUTHTOKEN'])) {
            session_start();
            $AuthToken = $_SERVER['AUTHTOKEN'];
            if ($AuthToken == null) {
                session_regenerate_id(true);
                echo $AuthToken = session_id();
                die();
            } else {
