...
<span class="lui__h1"><?php echo __('Новый тариф', array(), 'messages') ?></span>
...
<?php include_partial('hosting_plans/form_footer', array('hosting_plans' => $hosting_plans, 'form' => $form, 'configuration' => $configuration, '_partial' => isset($_partial))) ?>
<?php if (!$sf_request->isXmlHttpRequest() && !isset($_partial)): ?>
</div>
<?php endif; ?>
