...
<span class="lui__h1"><?php echo __('Новая', array(), 'messages') ?></span>
...
<?php include_partial('period/form_footer', array('period' => $period, 'form' => $form, 'configuration' => $configuration, '_partial' => isset($_partial))) ?>
<?php if (!$sf_request->isXmlHttpRequest() && !isset($_partial)): ?>
</div>
<?php endif; ?>
