...
<span class="lui__h1"><?php echo __('Новый сервер', array(), 'messages') ?></span>
...
<?php include_partial('server_list/form_footer', array('server_list' => $server_list, 'form' => $form, 'configuration' => $configuration, '_partial' => isset($_partial))) ?>
<?php if (!$sf_request->isXmlHttpRequest() && !isset($_partial)): ?>
</div>
<?php endif; ?>
