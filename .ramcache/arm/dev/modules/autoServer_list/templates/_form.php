...
<?php echo form_tag_for($form, '@server_list', array('_partial' => isset($_partial) ? $_partial : false)) ?>
...
<div class="lui__scroller_wrapper" style="position:relative;z-index:102;padding-left:10px;">
    <?php foreach ($configuration->getFormFields($form, $form->isNew() ? 'new' : 'edit') as $fieldset => $fields): ?>
      <?php include_partial('server_list/form_fieldset', array('server_list' => $server_list, 'form' => $form, 'fields' => $fields, 'fieldset' => $fieldset)) ?>
    <?php endforeach; ?>
</div>
</div>
<?php
