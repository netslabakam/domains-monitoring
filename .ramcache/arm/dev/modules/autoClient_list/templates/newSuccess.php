...
<span class="lui__h1"><?php echo __('Новый клиент', array(), 'messages') ?></span>
...
<?php include_partial('client_list/form_footer', array('client_list' => $client_list, 'form' => $form, 'configuration' => $configuration, '_partial' => isset($_partial))) ?>
<?php if (!$sf_request->isXmlHttpRequest() && !isset($_partial)): ?>
</div>
<?php endif; ?>
