...
<?php echo form_tag_for($form, '@client_list', array('_partial' => isset($_partial) ? $_partial : false)) ?>
...
<div class="lui__scroller_wrapper" style="position:relative;z-index:102;padding-left:10px;">
    <?php foreach ($configuration->getFormFields($form, $form->isNew() ? 'new' : 'edit') as $fieldset => $fields): ?>
      <?php include_partial('client_list/form_fieldset', array('client_list' => $client_list, 'form' => $form, 'fields' => $fields, 'fieldset' => $fieldset)) ?>
    <?php endforeach; ?>
</div>
</div>
<?php
