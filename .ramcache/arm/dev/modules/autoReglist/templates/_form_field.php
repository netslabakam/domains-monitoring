<?php if ($field->isPartial()): ?>
  <?php include_partial('reglist/'.$name, array('form' => $form, 'name' => $name, 'label' => $label, 'help' => $help, 'class' => $class,  'field' => $field, 'attributes' => $attributes instanceof sfOutputEscaper ? $attributes->getRawValue() : $attributes)) ?>
<?php elseif ($field->isComponent()): ?>
  <?php include_component('reglist', $name, array('form' => $form, 'name' => $name, 'label' => $label, 'help' => $help, 'class' => $class,  'field' => $field, 'attributes' => $attributes instanceof sfOutputEscaper ? $attributes->getRawValue() : $attributes)) ?>
<?php else: ?>
