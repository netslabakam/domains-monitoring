...
<span class="lui__h1"><?php echo __('Редактирование регистратора', array(), 'messages') ?></span>
...
<?php include_partial('reglist/form_footer', array('reglist' => $reglist, 'form' => $form, 'configuration' => $configuration)) ?>
<?php if (!$sf_request->isXmlHttpRequest() && !isset($_partial)): ?>
</div>
<?php endif; ?>