...
<?php echo form_tag_for($form, '@cs_setting', array('_partial' => isset($_partial) ? $_partial : false)) ?>
...
<div class="lui__scroller_wrapper" style="position:relative;z-index:102;padding-left:10px;">
    <?php foreach ($configuration->getFormFields($form, $form->isNew() ? 'new' : 'edit') as $fieldset => $fields): ?>
      <?php include_partial('csSetting/form_fieldset', array('cs_setting' => $cs_setting, 'form' => $form, 'fields' => $fields, 'fieldset' => $fieldset)) ?>
    <?php endforeach; ?>
</div>
</div>
<?php
