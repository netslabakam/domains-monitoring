...
<span class="lui__h1"><?php echo __('Edit Setting', array(), 'messages') ?></span>
...
<?php include_partial('csSetting/form_footer', array('cs_setting' => $cs_setting, 'form' => $form, 'configuration' => $configuration)) ?>
<?php if (!$sf_request->isXmlHttpRequest() && !isset($_partial)): ?>
</div>
<?php endif; ?>