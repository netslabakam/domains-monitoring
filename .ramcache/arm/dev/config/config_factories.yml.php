...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => '/www/test.local/log/arm_dev.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => '/www/test.local/.ramcache/arm/dev/i18n',
  'lifetime' => 31556926,
  'prefix' => '/www/test.local/apps/arm/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('arm'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/www/test.local/.ramcache/arm/dev/template',
  'lifetime' => 86400,
  'prefix' => '/www/test.local/apps/arm/template',
)));
